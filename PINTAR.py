...
def c_rotura(f14, var):
	...
	if not var:
		lb_gris_c_roturas1=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas1.place(x=80, y=0)
		lb_gris_c_roturas2=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas2.place(x=80, y=44)
		lb_gris_c_roturas3=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas3.place(x=80, y=88)
		lb_gris_c_roturas4=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas4.place(x=80, y=132)
		lb_gris_c_roturas5=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas5.place(x=80, y=176)
		lb_gris_c_roturas6=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas6.place(x=80, y=220)
		lb_gris_c_roturas7=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas7.place(x=80, y=264)
		lb_gris_c_roturas8=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas8.place(x=80, y=308)
		lb_gris_c_roturas9=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas9.place(x=80, y=352)
		lb_gris_c_roturas10=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_c_roturas10.place(x=80, y=396)
		lb_gris_c_roturas11=Label(f14, bg=bg_gris, width=100, height=1)
...
def s_rotura(f14, var):
	...
	if not var:
		lb_gris_s_roturas1=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas1.place(x=80, y=22)
		lb_gris_s_roturas2=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas2.place(x=80, y=66)
		lb_gris_s_roturas3=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas3.place(x=80, y=110)
		lb_gris_s_roturas4=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas4.place(x=80, y=154)
		lb_gris_s_roturas5=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas5.place(x=80, y=198)
		lb_gris_s_roturas6=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas6.place(x=80, y=242)
		lb_gris_s_roturas7=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas7.place(x=80, y=286)
		lb_gris_s_roturas8=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas8.place(x=80, y=330)
		lb_gris_s_roturas9=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas9.place(x=80, y=374)
		lb_gris_s_roturas10=Label(f14, bg=bg_gris, width=100, height=1)
		lb_gris_s_roturas10.place(x=80, y=418)
		lb_gris_s_roturas11=Label(f14, bg=bg_gris, width=100, height=1)
...
def jean(f14, var):
	global lb_jean
	if not var:
		lb_jean=Label(f14, bg=bg_gris, width=9, height=50)
...
def blue(f14, var):
	global lb_blue
	if not var:
		lb_blue=Label(f14, bg=bg_gris, width=9, height=50)
...
def gris(f14, var):
	global lb_gris
	if not var:
		lb_gris=Label(f14, bg=bg_gris, width=9, height=50)
...
def negro(f14, var):
	global lb_negro
	if not var:
		lb_negro=Label(f14, bg=bg_gris, width=9, height=50)
...
def oxido(f14, var):
	global lb_oxido
	if not var:
		lb_oxido=Label(f14, bg=bg_gris, width=9, height=50)
